...
const BaseMapWithNoSSR = dynamic(() => import('../../../components/Surveys/create/BaseMap'), {
  ssr: false,
});

const HexagonOverlayWithNoSSR = dynamic(() => import('../../../components/Surveys/create/HexagonOverlay'), {
  ssr: false,
});
...
const MapContainer: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      {/* Metadata Display */}
      <div className="flex justify-between items-center p-4 bg-white rounded-lg shadow m-4 mb-2">
      ...
      {/* Map Container */}
      <div 
        className="bg-white m-4 rounded-lg shadow-md overflow-hidden"
