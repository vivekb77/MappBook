      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow-sm p-6 sm:p-8">
          ...
          <section className="mb-8">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Terms and Conditions of Use - MappBook</h2>
          ...
          {/* Service Limitations */}
          <section className="mb-12">
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">Service Limitations</h3>
            <div className="space-y-4 text-gray-700">
              <p>
          ...
          <section className="mb-12">
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">Personal Data and Privacy</h3>
            <div className="space-y-4 text-gray-700">
              <div>
          ...
          <section className="mb-12">
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">Intellectual Property</h3>
            <div className="space-y-4 text-gray-700">
              <p>
          ...
          {/* External Links */}
          <section className="mb-12">
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">External Links</h3>
          ...
          {/* Governing Law */}
          <section className="mb-12">
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">Governing Law and Jurisdiction</h3>
            <p className="text-gray-700">
