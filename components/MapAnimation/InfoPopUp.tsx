  ...
  return (
    <div className="absolute bottom-[55%] right-[1%]">
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="fixed w-[90vw] sm:w-[440px] max-h-[80vh] rounded-2xl bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-700 overflow-hidden flex flex-col">
