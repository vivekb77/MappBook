...
const BaseMap: React.FC<BaseMapProps> = ({
  ...
  return (
    <div className="flex flex-col bg-gray-100 w-full h-full">
      <div className="bg-green-800 px-3 py-2 rounded-lg mx-2 mt-2 mb-1.5 shadow-md">
        <div className="flex justify-center items-center">
          <FaTrophy className="mx-1.5 text-xl text-yellow-400" />
          <h1 className="text-lg font-bold text-center text-white m-0">IPL Fan Map 2025</h1>
          <FaBaseballBall className="mx-1.5 text-xl text-yellow-400" />
        </div>
        <p className="text-xs text-center text-teal-50 font-medium mt-0.5 mb-0">Vote for your favourite team and see who's winning India's heart</p>
      </div>
